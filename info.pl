...
<div id="main">
	...
	<div id="content">
		...
		<h4>Расписание занятий группы</h4> $groupList

		<iframe src="/cgi-bin/schedule_grp.pl?g=$myGroupId" id="GROUPLIST" 
			width="98%" height="400" SCROLLING=YES FRAMEBORDER=0>
		</iframe>
