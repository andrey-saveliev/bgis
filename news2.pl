...
<div id="main">
    ...
    <div id="cols" class="box">
		...
		<form method="post" action="news2_save.pl">
		    <input type="hidden" name="V00" VALUE="$userInfo->{USERID}">
		    <textarea name="content" style="width:100%" rows=10 onChange="alert('!!!');">Введите здесь содержание новости</textarea>
		    <table width="100%"><tr>
			<td>Дата: <input type="text" id="V01" name="V01" VALUE="" onFocus="this.blur()"></td>
